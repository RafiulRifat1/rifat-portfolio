export function JsonLd() {
  const structuredData = [{
    ...
    sameAs: [
      ...
      'https://www.linkedin.com/in/rifat/',
    ...
    description: 'Rifat is a Full Stack Developer specializing in React, Next.js, TypeScript, and Node.js. Creating modern web applications with clean, efficient code.'
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'Rifat',
    url: 'https://prasen.dev',
    description: 'Portfolio and blog of Rifat, Full Stack Developer',
    potentialAction: {
      '@type': 'SearchAction',
      'target': {
        '@type': 'EntryPoint',
