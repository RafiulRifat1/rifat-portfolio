...
export const metadata: Metadata = {
  ...
  title: {
    default: "Rifat | Full Stack Developer",
    template: `%s | Rifat`,
  },
  description: "Rifat is a Full Stack Developer from Bangladesh, with expertise in React, Next.js, TypeScript and Node.js. I create modern web applications and have a passion for clean, efficient code. View my portfolio to see my latest projects and technical blog posts.",
  keywords: ["Rifat", "Full Stack Developer", "React Developer", "Next.js Developer", "TypeScript Developer", "Node.js Developer", "Web Developer Bangladesh", "Software Engineer"],
  authors: [{ name: "Rifat" }],
  creator: "Rifat",
  publisher: "Rifat",
  alternates: {
  ...
  openGraph: {
    title: "Rifat | Full Stack Developer",
